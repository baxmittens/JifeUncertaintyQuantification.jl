...
function ASG(ogsuqasg::JifeUQASG, _fun)
...
function empirical_cdf_sampling(ogsuqasg::JifeUQASG, samplepoint::Vector{Float64}, MC_N::Int, postprocfun::F,  xdmf::XDMF3File) where {F<:Function}
...
# Arguments
- `ogsuqasg::`[`JifeUQASG`] : Stochastic OGS6 adaptive sparse grid model.
