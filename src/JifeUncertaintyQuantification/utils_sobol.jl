function scalar_sobolindex_from_field_result(ogsuq::JifeUQMCSobol, sobolvars, totalvariance, xdmf::XDMF3File, pathmapping::Union{Nothing,Dict{String,String}}=nothing)
...
function scalar_sobolindex_from_multifield_result(ogsuq::JifeUQMCSobol, sobolvars, field::Int, totalvariance, xdmf::XDMF3File, pathmapping::Union{Nothing,Dict{String,String}}=nothing)
	trimpath(p) = isnothing(pathmapping) ? format_ogs_path(p) : pathmapping[p]
	modeldef = ogs6_modeldef(ogsuq)
...
function scalar_sobolindex_from_multifield_result(ogsuqmc::JifeUQMCSobol, totsobolvars, fields::AbstractVector{Int}, varval, expval, xdmf::XDMF3File, pathmapping::Union{Nothing,Dict{String,String}}=nothing)
	trimpath(p) = isnothing(pathmapping) ? format_ogs_path(p) : pathmapping[p]
...
Writes the result of [`start!`](@ref)(ogsuqmcsobl::[`JifeUQMCSobol`](@ref)) to an XMDF file.
...
- `ogsuqmc::`[`JifeUQMCSobol`](@ref) : Instance of [`JifeUQMCSobol`](@ref).
- `sobolvars` : A result of [`start!`](@ref)(ogsuqmcsobl::[`JifeUQMCSobol`](@ref)).
...
"""
function write_sobol_field_result_to_XDMF(ogsuqmc::JifeUQMCSobol, sobolvars, fieldname::String, varval, expval, xdmf_proto_path::String, pathmapping::Union{Nothing,Dict{String,String}}=nothing)
	modeldef = ogs6_modeldef(ogsuqmc)
	stoch_params = stoch_parameters(ogsuqmc)
...
- `xdmf_proto_path::String` : Path to a xdmf file with similar topology like the result field.
"""
function write_sobol_multifield_result_to_XDMF(ogsuqmc::JifeUQMCSobol, sobolvars, field, fieldname::String, varval, expval, xdmf_proto_path::String, pathmapping::Union{Nothing,Dict{String,String}}=nothing)
	modeldef = ogs6_modeldef(ogsuqmc)
	stoch_params = stoch_parameters(ogsuqmc)
	xdmf = XDMF3File(xdmf_proto_path)
