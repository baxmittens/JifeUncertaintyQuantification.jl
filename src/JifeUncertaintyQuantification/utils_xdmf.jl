function integrate_nodal_result(field::Vector{Float64},xdmf::T,modeldef::JifeModelDef) where T
	error("integrate_nodal_result not implemented for type $T")
end

function integrate_cell_result(field::Vector{Float64},xdmf::T,modeldef::JifeModelDef) where T
...
function integrate_nodal_result(field::Vector{Float64}, xdmf::XDMF3File, modeldef::JifeModelDef)
...
function integrate_nodal_result_simplical_mesh_order_2(field::Vector{Float64}, xdmf::XDMF3File, modeldef::JifeModelDef)
...
function integrate_nodal_result_simplical_mesh_order_1(field::Vector{Float64}, xdmf::XDMF3File, modeldef::JifeModelDef)
	#only implemented for 2d results in XY plane
...
function integrate_cell_result(field::Vector{Float64}, xdmf::XDMF3File, modeldef::JifeModelDef)
...
function integrate_area(xdmf::XDMF3File, modeldef::JifeModelDef)
	#only implemented for 2d results in XY plane
...
function add_scalar_field!(xdmf::XDMF3File, field::Vector{Float64}, name::String, modeldef::JifeModelDef)
...
function integrate_result(field::Vector{Float64}, xdmf::XDMF3File, modeldef::JifeModelDef)
	if is_nodal(field, xdmf)
